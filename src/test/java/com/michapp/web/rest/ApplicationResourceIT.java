...
import com.michapp.IntegrationTest;
import com.michapp.domain.Application;
import com.michapp.repository.ApplicationRepository;
...
class ApplicationResourceIT {
    ...
    public static Application createEntity(EntityManager em) {
        Application application = new Application().name(DEFAULT_NAME).active(DEFAULT_ACTIVE);
        return application;
    }
    ...
    public static Application createUpdatedEntity(EntityManager em) {
        Application application = new Application().name(UPDATED_NAME).active(UPDATED_ACTIVE);
        return application;
    }
    ...
    void createApplication() throws Exception {
        ...
        assertThat(testApplication.getActive()).isEqualTo(DEFAULT_ACTIVE);
    }
    ...
    void putNewApplication() throws Exception {
        ...
        updatedApplication.name(UPDATED_NAME).active(UPDATED_ACTIVE);
        ...
        assertThat(testApplication.getActive()).isEqualTo(UPDATED_ACTIVE);
    }
    ...
    void partialUpdateApplicationWithPatch() throws Exception {
        ...
        partialUpdatedApplication.active(UPDATED_ACTIVE);
    ...
    void fullUpdateApplicationWithPatch() throws Exception {
        ...
        partialUpdatedApplication.name(UPDATED_NAME).active(UPDATED_ACTIVE);
