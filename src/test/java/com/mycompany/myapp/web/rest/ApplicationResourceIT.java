...
class ApplicationResourceIT {
    ...
    public static Application createEntity(EntityManager em) {
        Application application = new Application().name(DEFAULT_NAME).isActive(DEFAULT_IS_ACTIVE);
        return application;
    }
    ...
    public static Application createUpdatedEntity(EntityManager em) {
        Application application = new Application().name(UPDATED_NAME).isActive(UPDATED_IS_ACTIVE);
        return application;
    }
    ...
    void createApplication() throws Exception {
        ...
        assertThat(testApplication.getIsActive()).isEqualTo(DEFAULT_IS_ACTIVE);
    ...
    void putNewApplication() throws Exception {
        ...
        updatedApplication.name(UPDATED_NAME).isActive(UPDATED_IS_ACTIVE);
        ...
        assertThat(testApplication.getIsActive()).isEqualTo(UPDATED_IS_ACTIVE);
    ...
    void partialUpdateApplicationWithPatch() throws Exception {
        ...
        partialUpdatedApplication.isActive(UPDATED_IS_ACTIVE);
    ...
    void fullUpdateApplicationWithPatch() throws Exception {
        ...
        partialUpdatedApplication.name(UPDATED_NAME).isActive(UPDATED_IS_ACTIVE);
